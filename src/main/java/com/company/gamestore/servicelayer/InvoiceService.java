...
//    ConsoleRepository consoleRepository;
    ...
    @Autowired
    public InvoiceService(ProcessingFeeRepository processingFeeRepository, TshirtRepository tshirtRepository, SalesTaxRepository salesTaxRepository, InvoiceRepository invoiceRepository) {
...
//            }
           ...
           //If item exists, set unit price using price from the item's table
            ...
            if(tshirt.getQuantity() >= invoice.getQuantity()) {
                ...
                tshirtRepository.save(tshirt);  //update tshirt
            } else {
                throw new IllegalArgumentException("Not enough in stock");
            }
