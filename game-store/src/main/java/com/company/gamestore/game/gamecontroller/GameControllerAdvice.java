package com.company.gamestore.game.gamecontroller;

import com.company.gamestore.game.gamemodel.CustomErrorResponse;
...
public class GameControllerAdvice {
    ...
    public ResponseEntity<List<CustomErrorResponse>> gameValidationError(MethodArgumentNotValidException e) {
